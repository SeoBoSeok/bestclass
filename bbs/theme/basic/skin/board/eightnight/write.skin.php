...
<div class="container" style="padding: 100px 0;">
    ...
    <section id="bo_w">
        ...
        <div class="bo_w_info write_div">
            ...
            <?php } ?>
            <label for="wr_1" class="">일시</label>
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input half_input" size="50" placeholder="일시">
        </div>

        <div class="bo_w_info write_div">
          <label for="wr_2" class="">장소</label>
          <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input half_input" size="50" placeholder="장소">
        </div>
        ...
        <div class="btn_confirm write_div">
            <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn_cancel btn btn-danger">취소</a>
            <button type="submit" id="btn_submit" accesskey="s" class="btn_submit btn btn-outline-primary">작성완료</button>
        </div>
        </form>
