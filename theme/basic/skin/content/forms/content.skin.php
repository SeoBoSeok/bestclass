...
$_program = array("monday" => "공주근대건축만들기", "tuesday" => "공주문화재야행스트링아트",  "wednesday" => "소원종이등만들기", "thursday" => "가죽그립톡만들기", "friday" => "도자기모빌만들기", "saturday" => "천문대관측프로그램", "sunday" => "1박2일숙박프로그램", "202201" => "해설사 동반 투어", "202202" => "낭만만찬");
...
if ($_program_detail == "202201") {
    $_open = true;
}
if ($_program_detail == "202202") {
    $_open = true;
}
?>
<!-- <div class="sub-layout">
    <div class="container">
        <div class="text-center mt-5 fs-30">청약신청</div>
        ...
        <div class="apply">
            <div class="inner_box">
                ...
                <form id="reserveForm" action="/api/apply.php" method="POST" enctype="multipart/form-data">
                    ...
                    <tbody>
                    <tr>
                        <td class="ttl">청약 단지</td>
                        <td class="box6 ride_count">
                            <div class="box6_01">
                                <input type="text" id="rsv_program" class="rsv_program" name="rsv_program" value="둔곡지구" readonly />
                            </div>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td class="box6 ride_count">
                            <div class="box6_01">
                                <label for="time_1"><input type="radio" id="time_1" name="token" value="202201011830"><span>2022. 9. 2.(금) 18:30</span></label><br />
                                <label for="time_2"><input type="radio" id="time_2" name="token" value="202201011900"><span>2022. 9. 2.(금) 19:00</span></label><br />
                                <label for="time_3"><input type="radio" id="time_3" name="token" value="202201012000"><span>2022. 9. 2.(금) 20:00</span></label><br />
                                <label for="time_4"><input type="radio" id="time_4" name="token" value="202201021830"><span>2022. 9. 3.(토) 18:30</span></label><br />
                                <label for="time_5"><input type="radio" id="time_5" name="token" value="202201021900"><span>2022. 9. 3.(토) 19:00</span></label><br />
                                <label for="time_6"><input type="radio" id="time_6" name="token" value="202201022000"><span>2022. 9. 3.(토) 20:00</span></label><br />
                                <label for="time_7"><input type="radio" id="time_7" name="token" value="202201031830"><span>2022. 9. 4.(일) 18:30</span></label><br />
                                <label for="time_8"><input type="radio" id="time_8" name="token" value="202201031900"><span>2022. 9. 4.(일) 19:00</span></label><br />
                                <label for="time_9"><input type="radio" id="time_9" name="token" value="202201032000"><span>2022. 9. 4.(일) 20:00</span></label><br />
                            </div>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td class="box6 ride_count">
                            <div class="box6_01">
                                <label for="time_21"><input type="radio" name="token" id="time_21" value="20220201" checked><span>9. 4.(일) 19:00~20:30</span></label><br />
                            </div>
                        </td>
                    </tr>
                    <?php
                    ...
                    ?>                    
                    <tr>
                        <td class="ttl">청약자 정보</td>
                        <td class="box5">
                            <div class="box5_02">
                                <span>청약자명</span>
                                <input type="text" name="rsv_name" placeholder="청약자명을 입력해 주세요.">
                            </div>
                            <div class="box5_03">
                                <span>청약자 연락처</span>
                                <div class="tel1">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        청약자 : <span class="check_name"></span><br />
